...
> **SUPERSEDED EM PARTE (2026-06-11):** o deep-grep do jadx refutou a premissa "sheet": no Spoke, Editar parada é o `EditStopDialogFragment` (modal destination quase-full-screen), e o RotPro decidiu **página GoRouter full-screen** (D1). Escopo, fatos (F1–F16), decisões (D1–D8) e hardening (H1–H21) canônicos em [`docs/superpowers/specs/2026-06-11-area6-edit-stop-design.md`](../specs/2026-06-11-area6-edit-stop-design.md). Phase 2 (live-dump) já executada como **deep-grep estático** (workflow `wxcu78nhu` + greps manuais) — D4 runtime reduzido a 2 cliques. **Plano de execução task-by-task (20 tasks TDD): [`docs/superpowers/plans/2026-06-11-area6-edit-stop-plan.md`](./2026-06-11-area6-edit-stop-plan.md)** — as Phases 3/4 abaixo estão detalhadas lá; executar O PLANO, não os bullets genéricos abaixo.
